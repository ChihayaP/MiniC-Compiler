...
typedef enum enum_node_kind {
    ...
    _EXP,_NUMBER,_LVAL,
    _INT_CONST,_ARRAY,_IDENT,_FUNC_CALL,_ARGS,
    ID,LABEL,GOTO,FUNCTION,PARAM,ASSIGNOP,NOT,LT,LE,GT,GE,EQ,NE,BR,BC,BT,BF,BOOL,RC_SIGN,ARG,CALL,
    _BLOCKITEMLIST,_BLOCKITEM_
} node_kind;
